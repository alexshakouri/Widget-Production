...
int main()
{
    ...
    int numConsumers = 1;
    int maxWidgets = 50;
    int brokenWidget = 1; //Which produced widget should be broken
    int widgetNum = 0;
    bool isBroken = false;
    ...
    for (int i = 0; i < numConsumers;i++) {
        ...
        thread t_c(consume_widget, ref(createdWidgets), consumerNum, ref(isBroken));
...
void consume_widget(vector<widget*> &createdWidgets, string consumer, bool &isBroken) {
